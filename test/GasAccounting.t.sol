...
contract GasAccountingTest is Test {
    ...
    function getInitialClaims(uint256 gasMarker) public view returns (uint256 claims) {
        ...
        claims = rawClaims + ((rawClaims * mockGasAccounting.SURCHARGE_RATE()) / 10_000_000);
    }
    ...
    function test_releaseSolverLock() public {
        ...
        maxGasUsed = (maxGasUsed + ((maxGasUsed * mockGasAccounting.SURCHARGE_RATE()) / 10_000_000))
            * tx.gasprice;
        ...
        assertGt(
            ...
            (calldataCost + ((calldataCost * mockGasAccounting.SURCHARGE_RATE()) / 10_000_000))
                * tx.gasprice
