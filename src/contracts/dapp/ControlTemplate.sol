...
abstract contract DAppControlTemplate {
    ...
    uint128 internal constant DEFAULT_BUNDLER_SURCHARGE_RATE = 1_000_000; // out of 10_000_000 = 10%
    ...
    function getBundlerSurchargeRate() public view virtual returns (uint128) {
