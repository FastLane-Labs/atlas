...
struct CallConfig {
    ...
    bool exPostBids;
    // allowAllocateValueFailure: If true, the metacall will proceed even if the allocate value hook fails. If false,
    // the metacall will revert if the allocate value hook fails.
