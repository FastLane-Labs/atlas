...
contract DeployAtlasScript is DeployBaseScript {
    uint256 ESCROW_DURATION = 32; // Optimized for Hyperliquid block times 30s for 1 block per second
    uint256 ATLAS_SURCHARGE_RATE; // Set below
    address L2_GAS_CALCULATOR = address(0); // No L2 gas calculator for Hyperliquid
